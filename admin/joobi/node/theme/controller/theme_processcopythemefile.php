...
$fileDest=JOOBI_DS_THEME.$destfolder. '/'.$folder. '/'.$fileType;
if($fileType=='view')$fileExt='php';
elseif($fileType=='css')$fileExt='css';
else $fileExt='js';
if($fileClass->exist($fileDest. '/'.$filename.'.'.$fileExt)){
...
$fileClass->copy($fileDest. '/'.$fileToCopy, $fileDest. '/'.$filename.'.'.$fileExt );
return true;
}}