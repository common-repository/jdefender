...
$srcfolder=JOOBI_DS_THEME . $destfolder.'/'.$folder;
$fileClass=WGet::file();$systemFolderC=WGet::folder();
if(!$systemFolderC->exist( JOOBI_DS_THEME . $destfolder.'/'.$folder )) return '';
...
$destfolder=$this->destfolder($type);
if($filetype=='main')  $path=JOOBI_DS_THEME.$destfolder.'/'.$folder. '/'.$file;
else $path=JOOBI_DS_THEME.$destfolder.'/'.$folder. '/'.'/'.$file;
...
$destfolder=$this->destfolder($type);
if($filetype=='main'){
$path=JOOBI_DS_THEME.$destfolder. '/'.$folder.'/index.html';
}else{
$path=JOOBI_DS_THEME.$destfolder. '/'.$folder. '/'.$file;}
$fileClass=WGet::file();
