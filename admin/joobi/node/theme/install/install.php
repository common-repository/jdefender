...
$src=JOOBI_DS_NODE .'theme/install/image/default_theme.png';
if(!$filehandler->exist($src )) return true;$dest='images/theme' ;
$content=$filehandler->read($src );
$filehandler->copy($src, JOOBI_DS_MEDIA . $dest.'/thumbnails/default_theme.png');
