...
$yid=WView::get($appName.'_main_fe','yid', null, null, false);
...
$appDone=get_option($app.'_first_install');
if(empty($appDone)){
update_option($app.'_first_install','done');
$APP_NAME=ucfirst( substr($app, 1 ));
$htmlMess .='To start with j'.$APP_NAME.' ';
$htmlMess .='&nbsp;&nbsp;&nbsp; <a target="_blank" href="admin.php?page='.$app.'" class="skip button-primary">'.'Click Here!'.'</a>';
...
$html='';
$appToShowUpgradeA=array('jdefender','jstore','jcatalog');
