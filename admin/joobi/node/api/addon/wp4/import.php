...
$query='SELECT `ID`, `display_name`, `user_login`, `user_email`,1, 0, 1 FROM `#__users` ';
$query2='INSERT IGNORE `#__members_node` ( `id`, `name`, `username`, `email`, `confirmed`, `blocked`, `rolid` ) '.$query;
