...
switch($errorMessage){
case 'emptyParam':
if($showMessage)$this->userW('1251905717NHWT');
return true;
break;
case 'unknowSite':
if($showMessage)$this->userW('1251905717NHWU');
return true;
break;
case 'noLicenses':
if($showMessage)$this->userW('1251912852OWAG');
return true;
break;
default:
if($showMessage)$this->userW('1298350280PMMA');
