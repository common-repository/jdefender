...
$folder=WGet::folder();
$path=JOOBI_DS_ROOT . JOOBI_FOLDER.'/'.$mainRep.'/'.$ffolder.'/'.$fpath;
...
if($fileext=='php'){
 if($subfolder){
$path=JOOBI_DS_ROOT . JOOBI_FOLDER.'/'.$mainRep.'/'.$ffolder.'/'.$type.'/'.$filename.'/'.$filename .'.'. $fileext;
 }else{
 $path=JOOBI_DS_ROOT . JOOBI_FOLDER.'/'.$mainRep.'/'.$ffolder.'/'.$type.'/'.$filename .'.'. $fileext;
