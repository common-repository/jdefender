...
$this->imagePath=$imageM->_completePath.'/'.$imageM->name.'.'.$imageM->type;
...
$folder=WGet::folder();
$turl=$imageM->_completePath.'/thumbnails';
$folder->create($turl, '', true);
$filesResizeC->dest=$turl.'/'.$imageM->name.'.'.$imageM->type;
if($filesResizeC->resizeImage()){
...
if($imageM->_resized)$imageM->_completePath=$imageM->_completePath.'/oversize';
return true;
}
