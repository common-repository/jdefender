...
if(isset($data->classes))$data->tagAttributes .=' class="'.$data->classes.'"';
if(isset($data->style))$data->tagAttributes .=' style="'.$data->style.'"';
if(isset($data->align))$data->tagAttributes .=' align="'.$data->align.'"';
