...
var $showButtonColor=false;
var $showButtonText=false;
var $showButtonIcon=true;
var $showButtonIconPosition='';
var $showButtonIconColored=false;
...
$showSearch=(!empty($this->htmlObj->search) || !empty($this->htmlObj->advSearch));
if(isset($this->htmlObj->pageNavO) && isset($this->htmlObj->limitMax)){
if(!empty($this->htmlObj->nestedView) && empty($this->htmlObj->searchWord) && $this->htmlObj->pageNavO->total < $this->htmlObj->limitMax)$showSearch=false;
elseif( WPref::load('LIBRARY_NODE_HIDESEARCH') && empty($this->htmlObj->searchWord) && $this->htmlObj->pageNavO->total < $this->htmlObj->limitMax)$showSearch=false;
}
if($showSearch){
$this->_magicHeader=true;
$basicSearchBox='';
