...
function create(){
if(empty($this->value)){
$libraryViewformsM=WModel::get('library.viewforms');
$libraryViewformsM->rememberQuery(true);
$libraryViewformsM->whereE('fid',$this->eid );
$did=$libraryViewformsM->load('lr','did');
$this->value=$did;
}
