...
if(empty($widgetO) || empty($widgetO->widgetid)) return '';
...
$pagiI=WView::pagination($uniqueNameState, $allWidgetParamsO->totalCount, $startLimit, $allWidgetParamsO->nb, 0, 'Items',$task );
