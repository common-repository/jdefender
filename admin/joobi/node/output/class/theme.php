...
$tagParams->widgetSlugID=WView::generateID('widget','m'.$tagParams->widgetID );
}
...
$file=WGet::file();
$themeHTMLPath=JOOBI_DS_THEME_JOOBI . $tagParams->themeType.'/'.$folder.'/' .'css/style.css';
