...
$year_now=WApplication::date("Y",$this->lastRun);$month_now=WApplication::date("n",$this->lastRun);$day_now=WApplication::date("j",$this->lastRun);$weekday_now=WApplication::date("w",$this->lastRun);$hour_now=WApplication::date("G",$this->lastRun);$minute_now=WApplication::date("i",$this->lastRun);
$compute_minute=true;
$compute_hour=true;
$compute_day=true;
$compute_month=true;
