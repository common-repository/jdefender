...
if(!empty($chedulerAddonC->taskowner)){
$uid=WUser::get('uid',$chedulerAddonC->taskowner );
$roleA=WUser::roles($uid );
WUser::set('uid',$uid );
WUser::set('name','cron task');
WUser::set('username', WUser::get('username',$uid ));
WUser::set('rolids',$roleA );
}
