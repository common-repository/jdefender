...
if(!$dkim){
$this->removeElements( array('apps_preferences_mail_form_dkim_dkimselector','apps_preferences_mail_form_dkim_dkimkeyloc','apps_preferences_mail_form_dkim_dkimpassphrase'));
}
return true;
}
}