...
WGlobals::setSession('gosht','dontCheckLogin', true);
$email=trim($email );
...
WGlobals::setSession('gosht','dontCheckLogin', false);
return $uid;
}
if(empty($name)){
...
if(!empty($extraParamsO->last_name))$contactsDetailsM->setVal('last_name',$extraParamsO->last_name );
...
if(empty($constantValue))$constantValue=WApplication::getFrameworkName();
