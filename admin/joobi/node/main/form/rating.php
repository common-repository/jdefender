...
class WForm_Corerating extends WForms_default {
	...
	function create() {
		...
		WText::load( 'main.node' );
				$this->content = '<div style="float:left;">' . $this->_ratingC->createHTMLRating( $this ) . '</div>&nbsp;<span id=jratingstarqer class="label label-danger" style="font-weight:bold;display:none;"> '.WText::t('1303355093GUFG').'</span>';
	return true;
	}
	function show() {
