...
class Main_Date_class extends WClasses {
	public function countDown($time,$precisonOfCountDown=0) {
		if ( $precisonOfCountDown < 1 ) $precisonOfCountDown = WPref::load( 'PMAIN_NODE_COUNTDOWNPRECISION' );			if ( $precisonOfCountDown < 1 ) $precisonOfCountDown = 2;
