...
var $folder='joobi'; var $type=0;
var $wid=0;
var $file='default.php'; 
protected $tmid=0;
var $basePath='';
var $lineend=null;
var $charset='UTF-8';
...
$html=$message->getM();
if(empty($html))$html='<div id="WMessage"></div>';
return $html;
}
...
$overwrittenPath=str_replace( JOOBI_DS_THEME_JOOBI, WPage::getTemplate('path'). '/joobi/',$themeHTMLPath );
...
$themeHTMLPath=$this->basePath.'site/'.$this->folder.'/';
$this->htmlfile=true;
break;
case 50:if(empty($this->folder))$this->folder=WView::getDefaultTheme();
$themeHTMLPath=$this->basePath.'mobile/'.$this->folder.'/';
$this->htmlfile=true;
break;
case 2:if(empty($this->folder))$this->folder=WView::getDefaultTheme(); $themeHTMLPath=$this->basePath.'admin/'.$this->folder.'/';
$this->htmlfile=true;
break;
...
if(empty($mainFolder))$mainFolder='node';
$themeHTMLPath=$this->basePath . $mainFolder.'/'.$this->folder.'/';
if(!empty($subFolderName))$themeHTMLPath .=$subFolderName.'/';
