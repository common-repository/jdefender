...
protected $_under=null;var $_keepAttributesOnDelete=true;
protected $_parentIdentifier='root';
protected $_dontExportA=array('lft','rgt');
protected $_skipTreeUpdate=false;
...
if(!isset($this->$parentMap )){
$this->$parentMap=1; $this->userE('1489317986NGHK');
